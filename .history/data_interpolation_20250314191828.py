...
def visualize_interpolation(original_csv, interpolated_csv):
    ...
    plt.plot(df_original["timestamp"], df_original["arousal"], 'ro-', label="Original Data (3s)", markersize=6, linestyle="None")

    # **Plot interpolated data**
    plt.plot(df_interpolated["timestamp"], df_interpolated["arousal"], 'b-', label="Interpolated Data (1s, spline)", linewidth=1)
