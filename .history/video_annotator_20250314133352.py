...
class VideoAnnotator:
    def __init__(self, video_name, output_path="output/", segment_duration=20):
        self.video_path = os.path.join("video/", video_name)
        self.audio_path = os.path.join("audio/", video_name.replace(".mkv", "_converted.mp3"))
        self.converted_video_path = os.path.join("video/", video_name.replace(".mkv", "_converted.mp4"))
