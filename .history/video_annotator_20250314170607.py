...
class VideoAnnotator:
    ...
    def start_annotation(self):
        """开始播放视频并进行标注"""
        convert_video(self.video_path, self.converted_video_path)
        ...
        video_duration = total_frames / frame_rate  # 视频总时长（秒）
        print(f"视频时长: {video_duration:.2f}s, FPS: {frame_rate}")
...
if __name__ == "__main__":
    video_name = "rgb_byz_baseline.mkv"
